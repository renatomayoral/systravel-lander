  ...
  <div class="container px-6 py-4 mx-auto">
      <div class="lg:flex">
          <div class="w-full -mx-6 lg:w-2/5">
              <div class="px-6">
                  <div>
                      <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Systravels</a>
                  </div>
                  
                  <p class="max-w-md mt-2 text-gray-500 dark:text-gray-400">Sistema hoteleiro.</p>
      ...
      <h4 class="h-px my-6 bg-gray-300 border-none dark:bg-gray-700"/>

      <div>
          <p class="text-center text-gray-800 dark:text-white">© 2021 Systravels Ltda. All Rights Reserved</p>
      </div>
  </div>
</footer>
);
